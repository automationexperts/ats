...
com.Send(general, com.Set_Origin, dummy) #set current position to zero
print('Current position set to zero')

com.Send(general, com.Go_Absolute_Pos, 10000) #unclear on how to read position of servo maybe ask DMM
print('should move to position 10000 and stop, 3 seconds should eclipse since start of move before next one')
t.sleep(3)
...
while var[0] == False:
    com.Send(general, com.Read_MainGain, dummy)
    var = com.Obtain()
Gain = var[3]
print('getting gain')
print('gain is ', Gain)
...
com.Send(general, com.Set_MainGain, 70)
...
com.Send(general, com.Set_MainGain, Gain)
